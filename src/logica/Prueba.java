...
public class Prueba {
	...
	public static void main(String[] args) {
		...
		System.out.println("Saldo Despu�s: " + lstCuentas.get("Stefania Aguirre").getSaldo());
		System.out.println();
		...
		System.out.println("Saldo Despu�s del Retiro: " + lstCuentas.get("Stefania Aguirre").getSaldo());
		System.out.println();
		...
		System.out.println("Idbolsillo despu�s : " + lstCuentas.get("Juan Tapasco").getBolsilloId());
		...
		System.out.println("Saldo Despu�s del traslado: " + lstCuentas.get("Stefania Aguirre").getSaldo());
		System.out.println("SaldoBolsillo Despu�s del traslado: " + lstCuentas.get("Stefania Aguirre").getBolsilloSaldo());
		System.out.println();
	 ...
	 * @return Retorna el mensaje de confirmaci�n o rechazo
	 */
		...
		if (!llave.equals("")) {
			...
			if(encontrada.getSaldo()==0) {
				if(encontrada.getBolsilloId().equals("")) {
					...
					return "N�mero de cuenta eliminado con exito " + numeroCuenta;	
				}
	 ...
	 * @return La respuesta del resultado de la transacci�n
	 */
	public static String depositar(int numeroCuenta,double deposito,HashMap<String, Cuenta> lstCuentas) {
		...
		if (!llave.equals("")) {
			...
			return "Dep�sito exitoso en cuenta de ahorros " + numeroCuenta;
		}
		
		return "ERROR en deposito de cuenta de ahorros. N�mero de cuenta no encontrada";
	}
	...
	public static String retirar(int numeroCuenta,double retiro,HashMap<String, Cuenta> lstCuentas) {
		...
		return "ERROR en retiro de cuenta de ahorros. N�mero de cuenta no encontrada";
	}
	/**
	...
	public static String trasladar(int numeroCuenta,double traslado,HashMap<String, Cuenta> lstCuentas) {
		...
		return "ERROR en traslado de cuenta de ahorros. N�mero de cuenta no encontrada";
	}
	
	/**
	 * 
	 * Metodo que crea un bolsillo en una cuenta buscada
	 * @param numeroCuenta Es el numero de cuenta la que se desea hacer la creaci�n del bolsillo
	 * @param lstCuentas Es la lista de cuentas donde se va a buscar el elemento deseado
	 * @return  La respuesta del resultado de la transacci�n
	 */
	public static String abrirBolsillo(int numeroCuenta, HashMap<String, Cuenta> lstCuentas) {
		...
		if (!llave.equals("")) {
			...
			if(!encontrada.getBolsilloId().equals(numeroCuenta+"b")) {
				...
				return "Creaci�n de bolsillo exitosa " +  encontrada.getBolsilloId();
			}
	 ...
	 * @param numeroCuenta Es el numero de cuenta de bolsillo la que se desea hacer la creaci�n del bolsillo
	 * @param lstCuentas Es la lista de cuentas donde se va a buscar el elemento deseado
	 * @return  La respuesta del resultado de la transacci�n
	 */
	public static String cerrarBolsillo(String numeroCuentaBolsillo, HashMap<String, Cuenta> lstCuentas) {
		...
		if (!llave.equals("")) {
			...
			if(encontrada.getBolsilloId().equals(numeroCuenta+"b")) {
				...
				encontrada.setBolsilloSaldo(0);
				return "Cancelaci�n de bolsillo exitosa " +  numeroCuenta;
			}
			return "ERROR. No existe un bolsillo en la cuenta " + numeroCuenta;
		}
		return "ERROR en eliminaci�n de bolsillo. N�mero de cuenta no encontrada";
	}
	
	//<---------------- Metodos de Apoyo ---------------------->
	/**
	 * Metodo que busca a un propietario dentro de la lista de propietarios comparando sus numero de cuenta
	 * @param numeroCuenta Es el n�mero de cuenta que se desea encontrar dentro de la lista
