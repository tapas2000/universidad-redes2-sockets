...
public class VentanaCopia extends JFrame implements ActionListener{
	...
	public static EchoTCPClientCopia ec = new EchoTCPClientCopia();	
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaCopia frame = new VentanaCopia();
